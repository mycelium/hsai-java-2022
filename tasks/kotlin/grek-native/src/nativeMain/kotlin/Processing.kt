 ...
 */
fun <R> R.processContents(contents: Sequence<String>): MatchingLines where R : Reader<Options> {
...
fun <R> R.processFileContents(filePath: String, contents: Sequence<String>): ProcessedFile where R : Reader<Options> =
    ProcessedFile(filePath, processContents(contents))